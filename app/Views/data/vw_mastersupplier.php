                        ...
                        <div class="row">
                                ...
                                <div class="form-group">
                                    <div class="checkbox">
                                        <label class="form-check-label">
                                            <input type="checkbox" value="1" id="ppn1" name="ppn1" />
                                            PPN 1%
                                        </label>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    <div class="checkbox">
                                        <label class="form-check-label">
                                            <input type="checkbox" value="10" id="ppn10" name="ppn10" />
                                            PPN 10%
                                        </label>
                                    </div>
                                </div>
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if (data.ppn1 == 1) {
                    ...
                    $('#ppn1').prop('checked', false);
                }
                if (data.ppn10 == 10) {
                    $('#ppn10').prop('checked', true);
                } else {
                    $('#ppn10').prop('checked', false);
                }
                $('#md-form-supplier').modal('show');
